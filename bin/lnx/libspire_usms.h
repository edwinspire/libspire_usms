...
gchar* edwinspire_usms_table_contacts_fun_contact_address_edit_xml (edwinspireuSMSTableContacts* self, gint idcontact, const gchar* inidlocation, gdouble ingeox, gdouble ingeoy, const gchar* inmstreet, const gchar* insstreet, const gchar* inother, const gchar* innote, const gchar* ints, gboolean fieldtextasbase64);
...
gchar* edwinspire_usms_phone_table_fun_phone_address_edit_xml_from_hashmap (edwinspireuSMSPhoneTable* self, GeeHashMap* data, gboolean fieldtextasbase64);
gchar* edwinspire_usms_phone_table_fun_phones_address_edit_xml (edwinspireuSMSPhoneTable* self, gint idphone, const gchar* inidlocation, gdouble ingeox, gdouble ingeoy, const gchar* inmstreet, const gchar* insstreet, const gchar* inother, const gchar* innote, const gchar* ints, gboolean fieldtextasbase64);
