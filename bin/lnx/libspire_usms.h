...
gchar* edwinspire_usms_table_sms_out_AllXml (edwinspireuSMSTableSMSOut* self, GDateTime* start, GDateTime* end, gint maxrow);
GeeArrayList* edwinspire_usms_table_sms_out_All (edwinspireuSMSTableSMSOut* self, GDateTime* start, GDateTime* end, gint maxrow);
